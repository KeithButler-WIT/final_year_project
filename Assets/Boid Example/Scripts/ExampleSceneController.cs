...
public class ExampleSceneController : MonoBehaviour
{
    ...
    private void SpawnBoid(GameObject prefab, int swarmIndex)
    {
        ...
        boidInstance.transform.localRotation = Quaternion.Euler(Random.Range(0, 360), 0, Random.Range(0, 360));
        // boidInstance.transform.localPosition.y = 0;
        // boidInstance.transform.localRotation.y = 0;
